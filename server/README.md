...
- **v1.2.0**: 채팅 요약 입력 토큰 최적화 - 전처리로 약 50% 토큰 절감
...
- 채팅 요약 기능
  - 채팅 로그 수집 및 배치 저장
  - Gemini AI를 활용한 채팅 요약
  - 입력 토큰 최적화 전처리 (이모티콘/사진 제거, 단순 반응 필터링, 메시지 병합, 타임스탬프 축소)
...
- `POST /chat-logs/batch`: 채팅 로그 배치 저장
- `POST /summarize-chat`: 채팅 요약 요청
