...
│   ├── 거상봇.js            # 거상 사통팔달 / 육의전 연동
│   ├── 채팅전파봇.js         # 채팅방 간 메시지 릴레이
│   └── <봇이름>.md          # 봇별 상세 문서 (명령어, 설정, 변경이력)
...
| 봇 | 설명 | 문서 |
| ---- | ------ | ------ |
| API.js | URL 자동 요약, 번역, 이미지 전송, 환율/증시 | [API.md](bots/API.md) |
| 마비노기봇.js | 마비노기 모바일 알림, 랭킹, 룬워드, 운세 | [마비노기봇.md](bots/마비노기봇.md) |
| 관리봇.js | 봇 관리, 모니터링, 유저 차단 (오너 전용) | [관리봇.md](bots/관리봇.md) |
| 채팅봇.js | 커뮤니티 (레벨, 칭호, 추천/비추, 랭킹) | [채팅봇.md](bots/채팅봇.md) |
| 요약봇.js | 채팅 로그 수집, AI 요약, 통계, 인물평 | [요약봇.md](bots/요약봇.md) |
| 라오킹봇.js | 라이즈 오브 킹덤즈 일정, 브리핑, 생일 | [라오킹봇.md](bots/라오킹봇.md) |
| 거상봇.js | 거상 사통팔달/육의전 연동, 알람 | [거상봇.md](bots/거상봇.md) |
| 채팅전파봇.js | 채팅방 간 메시지 릴레이 | [채팅전파봇.md](bots/채팅전파봇.md) |

> 각 봇의 명령어, 설정, 변경 이력은 봇별 문서를 참조하세요.
